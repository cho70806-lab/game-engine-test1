...
public class ScoreTest : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        stage2.text = "STAGE 2 : " + HighScore.Load(1).ToString();
        stage3.text = "STAGE 3 : " + HighScore.Load(1).ToString();
        stage4.text = "STAGE 4 : " + HighScore.Load(1).ToString();
        stage5.text = "STAGE 5 : " + HighScore.Load(1).ToString();
    }
